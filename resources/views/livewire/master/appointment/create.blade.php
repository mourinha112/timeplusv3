<div>
    <x-heading>
        <x-title class="flex items-center gap-3">
            <x-carbon-calendar-add class="w-8 text-info" />
            Novo Agendamento
        </x-title>
        <x-subtitle>
            Crie um agendamento manualmente para um usuário e especialista.
        </x-subtitle>
    </x-heading>
            ...
            <x-form wire:submit="save">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <x-form-group>
                        ...
                        <x-select wire:model.live="service_mode">
                    ...
                    <x-form-group>
                        ...
                        <small class="text-base-content/60">
                            Valor é preenchido automaticamente ao escolher especialista/modalidade.
                        </small>
                    </x-form-group>
                    ...
                    <x-form-group>
                        <x-label required>Duração (minutos)</x-label>
                ...
                <x-form-group>
                    ...
                    <textarea wire:model="notes" class="textarea textarea-bordered w-full"
                        rows="3" placeholder="Notas sobre o agendamento (opcional)"></textarea>
                </x-form-group>
