    ...
    <div class="space-y-6">
        <x-heading>
            <div class="flex justify-between items-center w-full">
                ...
                <a href="{{ route('user.specialist.index') }}" wire:navigate class="btn btn-soft btn-sm btn-info">
                ...
                <div class="grid gap-6 md:grid-cols-[1fr_auto] items-start">
                    <div class="space-y-6">
                        <div class="flex flex-col sm:flex-row sm:items-center gap-4">
                            <div class="avatar">
                                <div class="w-24 h-24 rounded-full">
                                    ...
                                    <img src="{{ asset('storage/' . $specialist->avatar) }}" alt="Foto do especialista" class="w-full h-full object-cover" />
                                    @else
                                    <div class="bg-info text-primary-content rounded-full w-full h-full flex items-center justify-center">
                                        <span class="text-3xl font-bold">{{ strtoupper(substr($specialist->name ?? 'N/A', 0, 1)) }}</span>
                                    </div>
                                    @endif
                                </div>
                            </div>
                        ...
                        <div class="p-4 bg-base-200/30 rounded-lg space-y-2">
                            ...
                            <p class="text-sm text-base-content/80 whitespace-pre-line break-words break-all" style="word-break: break-word; overflow-wrap: anywhere;">{{ $specialist->summary }}
                            </p>
                        </div>
                        @endif
                        ...
                        <div class="p-4 bg-base-200/30 rounded-lg space-y-2">
                            ...
                            <p class="text-sm text-base-content/80 whitespace-pre-line break-words break-all" style="word-break: break-word; overflow-wrap: anywhere;">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div class="p-4 bg-base-200/20 rounded-lg">
                                <div class="text-xs uppercase text-base-content/50">LGBTQIA+?</div>
                                <div class="text-base font-medium text-base-content">
                                    {{ $specialist->lgbtqia ? 'Sim' : 'Não' }}</div>
                            </div>
                            <div class="p-4 bg-base-200/20 rounded-lg">
