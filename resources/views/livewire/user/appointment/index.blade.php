                ...
                <table class="table overflow-auto">
                    ...
                    <tbody>
                        @foreach ($this->appointments as $appointment)
                            <tr class="{{ $this->needsPayment($appointment) ? 'bg-warning/10' : '' }}">
                                <th>{{ $appointment->id }}</th>
                                <td>
                                    <div class="flex items-center space-x-3">

                                        <div>
                                            <div class="font-bold">{{ $appointment->specialist->name }}</div>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td>
                                    ...
                                    @else
                                        <div class="tooltip" data-tip="Agendamento criado, aguardando pagamento.">
    ...
    @else
        <div class="min-h-[50vh] flex items-center justify-center">
            <div class="flex flex-col items-center justify-center space-y-8 max-w-sm w-full px-6">
                {{-- TODO:: Realizar um componente SVG --}}
                <div>
                ...
                <h2 class="text-base-content/70">Nenhuma sessão agendada.</h2>

                <a href="{{ route('user.specialist.index') }}" class="btn btn-info btn-block">
                    Encontrar especialista
                </a>
                <p class="text-center text-xs">O histórico será mostrado aqui após a realização da sua sessão.</p>
            </div>
        </div>
    @endif
</div>
