    ...
    <x-card>
        <x-card-body>
            ...
            @else
                <x-form wire:submit="submit">
                    ...
                    <x-form-group>
                        ...
                        <x-input wire:model="password_confirmation" placeholder="Confirme sua nova senha"
                            type="password" />
                    </x-form-group>
            ...
            <div class="mt-5">
                <x-text>
                    Lembra da sua senha?
                    <x-link wire:navigate href="{{ route('specialist.auth.login') }}">Voltar para o login</x-link>.
                </x-text>
            </div>
        </x-card-body>
    </x-card>
