<div>
    <x-heading>
        <x-title>Clientes</x-title>
        <x-subtitle>Gerencie seus clientes e visualize detalhes importantes.</x-subtitle>
    </x-heading>
    ...
    @else
        <div class="mt-20 flex items-center justify-center">
            <div class="flex flex-col items-center justify-center space-y-3 w-full px-6">
                {{-- TODO:: Realizar um componente SVG --}}
                <div>
                    <svg xmlns="http://www.w3.org/2000/svg" width="180" height="180" viewBox="0 0 964.71029 806.00281"
                ...
                <x-subtitle>Você não possui clientes.</x-subtitle>
                <x-text>O histórico será mostrado aqui após a realização da sua sessão.</x-text>
            </div>
        </div>
    @endif
</div>
